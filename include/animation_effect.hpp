...
class cAnimationEffect : public cAnimation {
	...
	private:
		...
		constexpr static int RFRAMES_PER_SFRAME = 5;	// Render frames per sprite frame
		constexpr static int FRAMES_IN_SPRITE = 10;
		constexpr static int RENDER_OFFSET_Y = -3;
